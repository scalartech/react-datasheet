...
var Cell = function (_PureComponent) {
  ...
  _createClass(Cell, [{
    ...
    value: function render() {
      ...
      var _ref = attributes || {},
          attributeStyle = _ref.style,
          restAttributes = _objectWithoutProperties(_ref, ['style']);
      ...
      var composedStyle = _extends({}, style || {}, attributeStyle || {}, style && style.position === 'sticky' ? _extends({
        position: style.position
      }, style.top != null ? { top: style.top } : {}, style.left != null ? { left: style.left } : {}) : {});

      var Tag = this.props.virtualized ? 'div' : 'td';
      var extra = Tag === 'td' ? { colSpan: colSpan, rowSpan: rowSpan } : {};
