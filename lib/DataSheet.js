...
var computeRowVirtualization = function computeRowVirtualization(_ref) {
  ...
  var overscan = typeof overscanCount === 'number' ? overscanCount : 5;
  var safeScrollTop = scrollTop || 0;
  var start = Math.max(0, Math.floor(safeScrollTop / rowHeight) - overscan);
  var end = Math.min(
    totalRows - 1,
  ...
  _createClass(DataSheet, [
    ...
    },
    {
      ...
      value: function searchForNextSelectablePos(
        ...
        var isCellDefined = function isCellDefined(_ref4) {
          var i = _ref4.i,
            j = _ref4.j;
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (enableColVirtualization) {
          ...
          var visibleCount = endCol >= startCol ? endCol - startCol + 1 : 0;
        ...
        var renderRows = function renderRows() {
          if (
            ...
            var _computeRowVirtualiza = computeRowVirtualization({
              ...
              start = _computeRowVirtualiza.start,
              end = _computeRowVirtualiza.end,
...
DataSheet.propTypes = {
  ...
  height: _propTypes2.default.number, // required when virtualized rows
  rowHeight: _propTypes2.default.number, // required when virtualized rows
  overscanCount: _propTypes2.default.number,
  listProps: _propTypes2.default.object,
  // Column virtualization options
  width: _propTypes2.default.number, // required when virtualized columns
  columnWidth: _propTypes2.default.number, // required when virtualized columns
  columnOverscanCount: _propTypes2.default.number,
};
