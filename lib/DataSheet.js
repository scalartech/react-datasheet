  ...
  _createClass(DataSheet, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var EffectiveSheetRenderer = SheetRenderer;
        var EffectiveRowRenderer = RowRenderer;
        var EffectiveCellRenderer = cellRenderer; // always use default cell renderer
        ...
        var renderRows = function renderRows() {
          if (
            ...
            var scrollTop = _this4.state.scrollTop || 0;
            var overscan =
              typeof overscanCount === 'number' ? overscanCount : 5;
            var start = Math.max(
              0,
