...
var computeColumnVirtualization = function computeColumnVirtualization(_ref2) {
  ...
  var widths = Array.isArray(columnWidths)
    ? columnWidths
        .slice(0, totalCols)
        .concat(
          Array(
  ...
  var visibleRight = safeScrollLeft + (viewportWidth || 0);
  ...
  var leftPad = prefix[start];
  var visibleSliceWidth = prefix[end + 1] - prefix[start];
  var rightPad = Math.max(0, totalWidth - leftPad - visibleSliceWidth);
    ...
    },
    {
      ...
      value: function render() {
        ...
        this.handleScroll = function (e) {
          ...
          var virtualization = _this4.props.virtualization;

          if (virtualization && Array.isArray(virtualization.columnWidths)) {
            var totalWidth = virtualization.columnWidths.reduce(function (
              sum,
              width,
            ) {
              return sum + width;
        ...
        var renderRowContent = function renderRowContent(row, i) {
          return _react2.default.createElement(
            ...
            (enableColVirtualization
              ...
              var cellWidth = enableColVirtualization
                ? columnWidths[j]
                : undefined;
              return _react2.default.createElement(
                _DataCell2.default,
        ...
        var totalContentWidth = enableColVirtualization
          ? columnWidths.reduce(function (sum, width) {
              return sum + width;
            }, 0)
          : undefined;
...
DataSheet.propTypes = {
  ...
  virtualization: _propTypes2.default.shape({
    ...
    columnWidths: _propTypes2.default.arrayOf(_propTypes2.default.number)
      .isRequired,
